...
class ImageButton: ScannerLightButton {



    init(icon: String) {
        super.init(offBackgroundColor: .cc_black, onBackgroundColor: .cc_white, offImageColor: .cc_white, onImageColor: .cc_black)
        onImage = UIImage(named: icon)?.ub_image(with: .cc_black)
        offImage = UIImage(named: icon)?.ub_image(with: .cc_white)

        setImage(onImage, for: .normal)
    }
    
//    init(onImage: String, offImage: String) {
//        super.init(offBackgroundColor: .cc_black, onBackgroundColor: .cc_white, offImageColor: .cc_white, onImageColor: .cc_black)
//        onImage = UIImage(named: onImage)?.ub_image(with: .cc_black)
//        offImage = UIImage(named: offImage)?.ub_image(with: .cc_white)
//
//        setImage(onImage, for: .normal)
//    }
