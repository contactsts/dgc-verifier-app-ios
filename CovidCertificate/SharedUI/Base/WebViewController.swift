...
//        guard let path = Bundle.main.path(forResource: local, ofType: "html", inDirectory: "Impressum/\(String.languageKey)/")
        guard let path = Bundle.main.path(forResource: "index", ofType: "html", inDirectory: "Privacy/\(String.languageKey)/")
        else { return }
...
//                string = string.replacingOccurrences(of: "{APP_NAME}", with: UBLocalized.verifier_app_name)
