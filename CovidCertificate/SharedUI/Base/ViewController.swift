...
var LCLLanguageChangeNotification = "LCLLanguageChangeNotification"
...
class ViewController: UIViewController {
    ...
    func addDismissButton() {
        ...
        navigationItem.rightBarButtonItem?.accessibilityLabel = UBLocalized.close_button
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(setTextTranslations), name: NSNotification.Name( LCLLanguageChangeNotification), object: nil)
    ...
    @objc public func setTextTranslations() {
