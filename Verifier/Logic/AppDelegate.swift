...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    internal func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        print("Current env = %@", Environment.current.rawValue)
        ...
        HCert.publicKeyStorageDelegate = HCertStorageDelegate.instance
...
//        }, updateTimeInterval: TimeInterval(60 * 60))
    ...
    func applicationDidBecomeActive(_: UIApplication) {
        ...
        CertificateService().syncCertificatesList {}
        ValueSetService().syncValueSets {}
        RuleService().syncRulesList {}
        CountryService().syncCountriesList {}
    }
