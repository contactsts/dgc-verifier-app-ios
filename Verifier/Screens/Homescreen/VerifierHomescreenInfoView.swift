...
class VerifierHomescreenInfoView: UIView {
    ...
    private var v1 : InfoView!
    
    let image2 = UIImage(named: "illu-home-step-2")
    private var v2 : InfoView!
    ...
    private func setup() {
        ...
        v1 = InfoView(text: UBLocalized.verifier_homescreen_pager_description_1, image: image1)
        v2 = InfoView(text: UBLocalized.verifier_homescreen_pager_description_2, image: image2)
    ...
    public func setTextTranslations() {
        v1.textLabel.text = UBLocalized.verifier_homescreen_pager_description_1
        v2.textLabel.text = UBLocalized.verifier_homescreen_pager_description_2
    }
